...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OffensiveModeAttributes'
        db.create_table(u'core_offensivemodeattributes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('round', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TrainerRoundHistory'])),
            ('spell_delay_modifier', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
            ('enemy_health', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'core', ['OffensiveModeAttributes'])


    def backwards(self, orm):
        # Deleting model 'OffensiveModeAttributes'
        db.delete_table(u'core_offensivemodeattributes')
