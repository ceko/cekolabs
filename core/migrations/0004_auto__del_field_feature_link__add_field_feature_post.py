...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Feature.link'
        db.delete_column('core_feature', 'link')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Feature.link'
        raise RuntimeError("Cannot reverse this migration. 'Feature.link' and its values cannot be restored.")
        # Deleting field 'Feature.post'
        db.delete_column('core_feature', 'post_id')
