...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainerRoundHistory.country_code'
        db.add_column(u'core_trainerroundhistory', 'country_code',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


        # Changing field 'OffensiveModeAttributes.health_per_second'
        db.alter_column(u'core_offensivemodeattributes', 'health_per_second', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'TrainerRoundHistory.country_code'
        db.delete_column(u'core_trainerroundhistory', 'country_code')


        # Changing field 'OffensiveModeAttributes.health_per_second'
        db.alter_column(u'core_offensivemodeattributes', 'health_per_second', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))
